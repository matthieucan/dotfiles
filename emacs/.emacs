...
(setq linum-disabled-modes-list '(org-mode org-agenda-mode help-mode mail-mode lisp-interaction-mode)) (defun linum-on () (unless (or (minibufferp) (member major-mode linum-disabled-modes-list)) (linum-mode 1)))
