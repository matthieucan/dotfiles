...
(use-package emacs
  ...
  (diff-added ((t (:background "green" :foreground "gray3"))))
  (diff-changed-unspecified ((t (:foreground "gray3"))))
  (diff-file-header ((t (:foreground "gray3"))))
  (diff-function ((t (:foreground "gray3"))))
  (diff-header ((t (:foreground "gray3"))))
  (diff-hunk-header ((t (:foreground "gray3"))))
  (diff-refine-added ((t (:foreground "gray3"))))
  (diff-refine-removed ((t (:foreground "gray3"))))
  (diff-removed ((t (:background "red" :foreground "gray3"))))
  (ediff-current-diff-A  ((t (:inherit "diff-removed"))))
  (ediff-current-diff-Ancestor  ((t (:foreground "black"))))
  (ediff-current-diff-B  ((t (:inherit "diff-added"))))
  (ediff-current-diff-C  ((t (:foreground "black"))))
  (ediff-even-diff-A  ((t (:foreground "black"))))
  (ediff-even-diff-Ancestor  ((t (:foreground "black"))))
  (ediff-even-diff-B  ((t (:foreground "black"))))
  (ediff-even-diff-C  ((t (:foreground "black"))))
  (ediff-fine-diff-A  ((t (:foreground "black"))))
  (ediff-fine-diff-Ancestor  ((t (:foreground "black"))))
...
(use-package python
  ...
  ;; pipx install 'python-lsp-server[all]' python-lsp-black pylsp-mypy
